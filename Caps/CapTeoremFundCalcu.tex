...
\exercise{Si la velocidad de una part\'{\i}cula es $v(t)=\cfrac{1}{1+\cos \left( 2t\right) },$ $t$ en metros $s$ en segundos, si
su posición en $t=\frac{\pi }{8}$ es $2$ metros. \ Hallar la función de posición de la part\'{\i}cula.}{La función de posición de la part\'{\i}cula es: $s(t)=-\cot \left( 2t\right) +\frac{1}{2}\csc \left(2t\right) +3-\frac{\sqrt{2}}{2}$}

\exercise{Si la aceleración de una part\'{\i}cula es $a(t)=\sen \left( 2t\right) +e^{2t}+2^{4t},$ con \ $t$ en metros $s$ en
segundos, su velocidad inicial es 6 metros por segundo y su posición inicial es 4 metros. \ Hallar la función de posición de la part\'{\i}cula.}{$s\left( t\right) =-\frac{\sen \left( 2t\right) }{4}+\frac{e^{2t}}{4}+\frac{2^{4t}}{16\ln ^{2}\left( 2\right) }+\left( 6-\frac{1}{4\ln \left(2\right) }\right) t+\frac{15}{4}-\frac{1}{16\ln ^{2}\left( 2\right) }$}

\exercise{Si la pendiente de la tangente a la gráfica de $f$ en $\left(x,f\left( x\right) \right)$ \ es $\cfrac{\cos  ^{2}x}{1+\sen x}$ y $f\left( \frac{\pi }{6}\right) =4$. Hallar la función
$f\left( x\right).$}{$f\left( x\right) =x+\cos x+4-\frac{\pi}{6}-\frac{\sqrt{3}}{2}$}

En los siguientes ejercicios para cada una de las funciones $f\left(
x\right) $ dadas, hallar el valor de $c$ que garantiza el teorema del valor
medio para integrales en los intervalos indicados y hacer una gráfica de la
situación.
...
Para cada una de las funciones $f\left( x\right) $ dadas en los siguientes ejercicios: a) Calcular la función $A\left( x\right) =\displaystyle\int_{a}^{x}f\left( t\right) dt$, de área de acumulación de $f\left( x\right) $ a partir del valor de $t=a$ indicado. b) Hallar la derivada respecto a $x$ de la función área de acumulación $\frac{dA}{dx}$.
...
\subexercise{$\displaystyle\int_{0}^{\pi }\sin \left( \frac{1}{4}x\right) dx$=}{$\allowbreak 4-2\sqrt{2}$}

\subexercise{$\displaystyle\int_{0}^{\pi }\left( \cos \left( \frac{1}{2}x\right) +\sin \left( \frac{1%
}{2}x\right) \right) ^{2}dx$}{$\pi +2$}

\subexercise{$\displaystyle\int_{0}^{1}\left( \sqrt[3]{8t}-5t^{\frac{3}{4}}+7\sqrt[7]{t}\right) dt$}{$\allowbreak \frac{267}{56}$}
...
\subexercise{$\displaystyle\int_{0}^{1}\left( 2t+3\right) ^{4}dt$}{$\allowbreak \frac{1441}{5}$}
\end{multicols}

\exercise {Hallar el área de la región limitada por las gr�ficas de:}

\subexercise {$y=x^{4}+1,$ el eje $x$, el eje $y$ y la recta $x=3$}{$\allowbreak \frac{258}{5}u^{2}$}

\subexercise {$y=\cos(2x)$, el eje $x$, el eje $y$ y la recta $x=\frac{\pi }{8}$}{$\allowbreak \frac{1}{4}\sqrt{2}u^{2}$}

\subexercise {$y=\cfrac{x^{4}+x+1}{x^{6}},$ el eje $x$, y las rectas $x=1$ y $x=2$}{$\allowbreak \frac{297}{320}u^{2}$}

\subexercise {$y=\cfrac{x^{4}+1}{x^{2}+1},$ el eje $x$, el eje $y$ y la recta $x=1$}{$\allowbreak \left( \frac{1}{2}\pi -%
\frac{2}{3}\right) u^{2}$}

\subexercise {$ y=\cfrac{\sen^{2}x+1}{\cos ^{2}x},$ el eje $x$, el eje $y$ y la recta $x=\frac{\pi }{4}$}{$\left(
\allowbreak 2-\frac{1}{4}\pi \right) u^{2}$}

\subexercise {$y=\cfrac{1}{\sqrt{9-x^{2}}},$ el eje $x$, y la recta $x=1$}{$\allowbreak \frac{1}{2}\pi u^{2}$}
