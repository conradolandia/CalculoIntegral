...
\begin{ejemplo}
  \textnormal{Halle el área de la región limitada por las figuras de {\footnotesize $y=\sqrt{\frac{1}{2}x+4}$} y {\footnotesize $y=\sqrt{100-x}$} para {\footnotesize $y\geq 0.$}}
\end{ejemplo}
\emph{Solución.} Encontremos los puntos de corte de las curvas dadas: si {\footnotesize $\sqrt{\frac{1}{2}x+4}=\sqrt{100-x}$,} entonces {\footnotesize $\cfrac{1}{2}x+4=100-x$,} es decir, {\footnotesize $\cfrac{3}{2}x=96$} o también $x=64$, con lo cual {\footnotesize $y=\sqrt{100-64}=6.$} La figura de la región, se muestra a continuación:
...
\begin{ejemplo}
  \textnormal{Halle el volumen del sólido cuya base está dada por la región {\small $R=\left\{ \left( x,y\right) :\frac{x^{2}}{100}+\frac{y^{2}}{36}\leq 1\right\} $} y cuyas secciones transversales perpendiculares al eje $x$ son triángulos rectángulos isósceles con un lado sobre la base.}
\end{ejemplo}
...
\begin{ejemplo}
  ...
  región limitada por $y=x^{2}$ y $y=x$ en torno a la recta \textit{$y=3$.}}
\end{ejemplo}
...
\begin{ejemplo}
  \textnormal{Halle el volumen del sólido de revolución generado al girar la
  región limitada por $x=y^{2}$ y $x=y+2$ alrededor de la recta \textit{$x=4$.}}
\end{ejemplo}
...
\begin{ejemplo}
  \textnormal{Halle el volumen del sólido de revolución generado al girar la región limitada por {\footnotesize $y=\cfrac{2x^{2}}{x^{2}+1}$} y $y=x^{2}$ alrededor del eje \textit{$x$.}}
\end{ejemplo}
...
\begin{ejemplo}
  ...
  región acotada por $y=x^{2}$ y $y=2x+3$ alrededor del eje \textit{$x$.}}
\end{ejemplo}
...
\begin{ejemplo}
  ...
  girar alrededor del eje $y$, la región limitada por las figuras de $y=\frac{1}{16}x^{5}+x+1$, el eje $x$, el eje $y$ y la recta \textit{$x=2$.}}
\end{ejemplo}
...
región limitada por las figuras de $y=x^{4}+x $, el eje $x$ y la recta $x=1$, en torno a la recta \textit{$x=3$.}}
\end{ejemplo}
...
\begin{ejemplo}
\textnormal{Halle la longitud de la curva dada por $y=\frac{1}{4}x^{2}-\frac{1}{2}\ln x$ desde el punto $\left( 1,\frac{1}{4}\right)$ hasta el punto \textit{$\left( 4,4-\ln
2\right) $.}}
\end{ejemplo}
...
\begin{ejemplo}
\textnormal{Halle el área superficial de la superficie de revolución generada al girar la curva dada por {\small $y=\sqrt{8x-x^{2}}$} para {\small $1\leq x\leq 6$} alrededor del eje \textit{$x$.}}
\end{ejemplo}
...
\begin{ejemplo}
\textnormal{Halle el centro de masa de una barra delgada que se encuentra sobre el eje $x$ en el intervalo $\left[ 1,4\right] $ y que tiene función
...
y=x^{2},y=x$}, con función de densidad $\rho \left( x\right) =12x.$}
\end{ejemplo}
...
\begin{ejemplo}
\textnormal{Halle el centro de masa de la placa delgada limitada por \textit{$%
y=x^{2},y=x$}, con función de densidad $\rho \left( x\right) =x^{2}.$}
\end{ejemplo}
