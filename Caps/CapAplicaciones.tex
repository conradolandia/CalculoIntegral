...
\end{align*}
Si hacemos la sustitución $z=\sqrt{16-x^{2}}$, tenemos que $z^{2}=16-x^{2}$ y $x\,dx=-zdz$, entonces
\begin{align*}
m&=\int_{0}^{4}x\sqrt{16-x^{2}}dx\\
&=\int_{4}^{0}z\left( -zdz\right)=\int_{0}^{4}z^{2}dz\\
...
\begin{aligned}
  ...
  _{1}^{4}\\
  &=\left( \int \sqrt{\sec ^{2}y}\frac{\sec ^{2}ydy}{\sqrt{3}}\right)\Bigg\vert
  _{1}^{4}
...
\exercise{$y=x^{4}$, $y=-x-1$, $x=-2$ y $x=0$}{$\frac{42}{5}\ u^{2}$}
...
\exercise {$y=\frac{1}{x}$, $y=\frac{1}{x^{2}}$, $x=1$ y $x=2$}{$\ln 2+1\ u^{2}$}

\exercise {$y=\frac{1}{x}$, $x=0$, $y=1$ y $y=2$}{$\ln 2\ u^{2}$}

\exercise {$y=1$ y $y=\frac{10}{x^{2}+1}$}{$20\tan^{-1}3-6\ u^{2}$}

\exercise {$y=2^{x}$, $y=5^{x}$, $x=-1$ y $x=1$}{$\frac{1}{5\ln 5}+\frac{3}{\ln 5}-\frac{1}{2\ln 5}\ u^{2}$}
...
\exercise {$y=\frac{25x^{2}}{x^{2}+9}$ y $y=x^{2}$}{$\frac{472}{3}-150\tan^{-1} \frac{4}{3}$}

\exercise {$y=(\sen^{-1}x)^2$ y $y=\sen^{-1} x$}{$2\sen 1-\sqrt{\frac{1}{2}\cos 2+\frac{1}{2}}-1$}

\exercise { $y=x\tan^{-1}x$ y $y=\tan^{-1} x$}{$\frac{1}{2}-\frac{1}{2}\ln 2\ u^2$}

\exercise {$y=\frac{2400}{x^{2}-16}$ y $y=\frac{2400}{x^{4}-16}$}{$600\ln 5-750\ln3-150\pi +300\tan^{-1} 2$}

\exercise{$y=2x^{3}-3x^{2}-9x$ y $ y=x^{3}-2x^{2}-3x$}{SIN RESPUESTA EN EL ORIGINAL}

\exercise {La región en el primer cuadrante acotada por $y=x^{-2}$, $y=8x$ y  $y=\frac{x}{8}$}{SIN RESPUESTA EN EL ORIGINAL}

\exercise {La región en el primer cuadrante acotada por $y=9-x^{2},\ y=8x$ y $y=\frac{5}{2}x$}{SIN RESPUESTA EN EL ORIGINAL}

\exercise {Halle el area de la región limitada por la hipérbola dada por la ecuación $9x^{2}-4y^{2}=36$ y la recta vertical $x=3$.\label{areafinal}}{SIN RESPUESTA EN EL ORIGINAL}
%\end{multicols}

\exercise{Hallar el volumen del sólido cuya base es la región limitada por $y=x^{2}$ y $y=4x$ y sus secciones transversales perpendiculares al eje $x$ son triángulos rectángulos isósceles con la hipotenusa sobre la base.}{$\frac{128}{15}u^{3}$}

\exercise{  Hallar el volumen del sólido cuya base es el disco centrado en $\left(0,0\right) $ de radio 2 y sus secciones transversales perpendiculares al eje
$x$ son triángulos equiláteros con un lado sobre la base.}{$\frac{%
32}{3}\sqrt{3}$ $u^{3}$.}

\exercise{ Hallar el volumen del sólido cuya base es el disco centrado en $\left(
0,0\right) $ de radio 2 y sus secciones transversales perpendiculares al eje
$x$ son cuadrados con la diagonal sobre la base.}{$\frac{64}{3}u^{3}$}

\exercise{Hallar el volumen del sólido cuya base es el disco centrado en $\left(
0,0\right) $ de radio 2 y sus secciones transversales perpendiculares al eje
$x$ son cuadrados con un lado sobre la base.} {$\frac{128}{3}u^{3}$}

\exercise{Hallar el volumen del sólido cuya base es la región limitada por $%
x=y^{2}$ y $x=4$ y sus secciones transversales perpendiculares al eje $x$
son discos con el diámetro sobre la base.}{$8\pi u^{3}$}

\exercise{Hallar el volumen del sólido cuya base es el disco centrado en $\left(
0,0\right) $ de radio 2, y sus secciones transversales perpendiculares al
eje $x$ son discos con el diámetro sobre la base.}{$\frac{32}{3}\pi
u^{3}$}

\exercise{Hallar el volumen del sólido cuya base es la región limitada por $%
y=2\sen x$ y $y=0,0\leq x\leq \pi $ y sus secciones transversales perpendiculares al eje $x$
son triángulos equiláteros con un lado sobre la base.} {$\frac{\sqrt{3}%
\pi }{2}\allowbreak \pi u^{3}$}

\exercise{Hallar el volumen del sólido cuya base es la región limitada por $%
y=\tan x$ y $y=\sec x,x=-\frac{\pi }{4},x=\frac{\pi }{4},$ y sus secciones
transversales perpendiculares al eje $x$ son rectángulos con el largo
sobre la base y tal que la altura es la mitad del largo.} {$\frac{244}{21}\pi u^{3}$}

En los ejercicios \ref{volinic} a \ref{volfin} encuentre el volumen del sólido de revolución que se obtiene al hacer girar la región limitada por las curvas dadas en torno al eje indicado. Dibuje la región y el sólido.
...
\exercise{Alrededor del eje $x$.} {$V=\frac{3}{10}\pi u^{3}$}

\exercise{Alrededor del eje $y$.} {$V=\frac{3}{10}\pi u^{3}$}

\exercise{Alrededor de la recta $y=2$.} {$V=\frac{31}{30}\pi u^{3}$}

\exercise{$y=\sec x$, $y=1$, $x=-1$, $x=1$, alrededor del eje $x$.} {$V=\pi (2\tan (1)-2)u^{3}$}

\exercise{$y=\sen x$, $y=\cos x$, $x=0$, $x=\frac{\pi }{4}$.}

\exercise{En torno al eje $x$.}{$V=\frac{\pi }{2}u^{3}$}

\exercise{En torno al eje $y$.}{$V=\frac{\pi }{2}\left( \sqrt{2}\pi -4\right)u^{3}$}

\exercise{Eje de giro $x=\frac{\pi }{4}$} {$V=\frac{\pi }{2}\left( 4-\pi \right)
u^{3}$}

\exercise{Eje de rotación $y=1$}{$V=\frac{\pi }{2}\left( 4\sqrt{2}-5\right)u^{3}$}

\exercise{Eje de rotación $y=-1$}{$ V=\frac{\pi }{2}\left( 4%
\sqrt{2}-3\right) u^{3}$}
...
\subexercise{$y^{2}=(x-1)^{3}$ desde $P(1,0)$ a $Q(2,1)$.}
{$L=\frac{1}{27}\left[ (-5+9(2))^{\frac{3}{2}}-(-5+9(1))^{\frac{3}{2}}\right] u$}

\subexercise{$y=1-x^{\frac{2}{3}}$ desde $P(1,0)$ a $ P(-8,-3),Q(-1,0)$.} {$L=\left( -\frac{13\sqrt{13}}{27}+\frac{80\sqrt{10}}{27}\right)
u$}
...
\subexercise{$y=\ln (\sen x)$ \ $\frac{\pi }{6}\leq x\leq \frac{\pi }{3}.$} {$L=\ln \left( \frac{\sqrt{3}}{3(\sqrt{3}-2)}\right) u$}

\subexercise{$y=\ln (\frac{e^{x}+1}{e^{x}-1})$ \ $1\leq x\leq 2.$
} {$L=\left( \frac{1}{2}\ln \left( e^{2}+1\right) -\frac{1}{2}\right)
u$}

\subexercise{$\ y=e^{x},0\leq x\leq 1$.} {$L=\left( \sqrt{e^{2}+1}+\ln \left( \frac{\sqrt{e^{2}+1}-1}{\sqrt{2}-1}%
\right) -1-\sqrt{2}\right) u$}
...
\begin{multicols}{2}
\subexercise{$y=\sqrt{x},4\leq x\leq 9. $} {$S=\frac{\sqrt{2}\pi }{3}\left( 19(19)^{\frac{1}{2}}-27\right) u^{2}$}

\subexercise{$y=x+4,0\leq x\leq 2.$} {$ S=10\sqrt{2}u^{2}$}

\subexercise{$y^{2}=4x+4.$} {$S= \frac{16\sqrt{2}\pi }{3}\left( 5\sqrt{5}-1\right) u^{2}$}

\subexercise{$y=x^{3},0\leq x\leq 2.$} {$S=\frac{1}{54}\left( 145(145)^{\frac{1}{2}}-1\right) u^{2}$}

\subexercise{$y=x^{3}+\frac{1}{12x},1\leq x\leq 2.$
} {$S= \frac{12289}{192}\pi u^{2}$}

\subexercise{$y=\frac{x^{2}}{4}-\frac{\ln x}{2},1\leq x\leq 4.$} {$S=\frac{\pi }{16}\left( 315-128\left( \ln 2\right) -16\ln ^{2}2\right)  u^{2} $ }

\subexercise{$y=\sen x,0\leq x\leq \pi $.} {$S=\pi \left( 2\sqrt{2}-\ln \left( \frac{\sqrt{2}+1}{\sqrt{2}-1}\right)\right) u^{2}$}

\subexercise{$x=\frac{1}{3}(y^{2}+2)^{\frac{3}{2}},1\leq y\leq 2.$} { $S= \frac{21}{2}\pi u^{2}$}

\subexercise{$x=2\ln y,1\leq y\leq 2.$} {$S=2\pi \left( 4\sqrt{2}+4\ln \left( 2\sqrt{2}+2\right) -\sqrt{5}-4\ln  \left( \sqrt{5}+1\right) \right) u^{2}$}
\end{multicols}

\exercise{Encuentre el área de la superficie que se obtiene al girar la curva dada en torno al eje $y$}

\subexercise{$x=\frac{1}{2}y^{4}+\frac{1}{16y^{2}},1\leq y\leq 3.$} {$S=\frac{2127389}{1296}\pi u^{2}$}

\exercise{En los siguientes ejercicios, Halle la masa de las siguientes barras
...
\subexercise{$\rho \left( x\right) =\left\{
  ...
  \subexercise{$\rho \left( x\right) =\sen \left( 2x\right) +\tan x;$ $0\leq x\leq \frac{%
  \pi }{4}.$}{$0.84657$ unidades de masa.}

  \subexercise{$\rho \left( x\right) =x\sqrt{16-x^{2}};$ $0\leq x\leq 4.$}{$\frac{64}{3}$unidades de masa.}

  \subexercise{$\rho \left( x\right) =\frac{x}{\sqrt{x^{2}+16}};$ $0\leq x\leq 3.$}{$R:1$ unidad de masa.}

  \subexercise{$\rho \left( x\right) =x^{2}e^{x};$ $0\leq x\leq \ln 3.$}{$1.029,2$ unidad de masa.}

  \subexercise{$\rho \left( x\right) =\frac{\sqrt{x^{2}-9}}{x};$ $3\leq x\leq 5.$}{$1.2181$ unidad de masa.}

  \subexercise{$\rho \left( x\right) =\frac{x^{2}}{\sqrt{x^{2}+9}};$ $0\leq x\leq 4.$}{$5.,056,2$ unidad de masa.}
  %\end{multicols}

  \medskip

  En los ejercicios \ref{masainic} al \ref{masafin}, halle la masa y el centro de masa de las siguientes láminas delgadas\ representadas por la región limitada por las curvas o rectas dadas, con la función de densidad $\rho \left(x\right) $ indicada.
  ...
  \exercise{La región limitada por $y=x^{4},y=x^{2}$ con función de densidad
  $\rho \left( x\right) =x+3.$}{$m=\frac{1}{6},$ Centro de masa $\left( \frac{129}{203},\frac{5376}{29}%
  \right) .$}

  \exercise{La región del primer cuadrante acotada por $x^{2}+y^{2}=16,$ \ $\rho
  \left( x\right) =x.$}{$m=\frac{64}{3},$ Centro de masa $\left( \frac{3}{4}\pi ,\frac{3}{2}%
  \right) .$}

  \exercise{La región acotada por $y=1-\left\vert x\right\vert $ y el eje $x,$ \
  ...
  \exercise{La región limitada por $y=\sec ^{2}\left( x\right) ,\tan ^{2}\left(
    x\right) $ y las rectas $x=-\frac{\pi }{4},x=\frac{\pi }{4}$ con función
  de densidad $\rho \left( x\right) =2.$}{$m=\pi ,$ $\ $Centro de masa $\left( 0,0.77324\right) .$}

  \exercise{La región limitada por $y=x^{2}-x,y=x$ con función de densidad $%
  \rho \left( x\right) =\sqrt{x+1}.$}{$\ m=\frac{24}{35}\sqrt{3}+\frac{24}{35},$ Centro de masa $\left(
  1.051,0.65029\right)$.}

  \exercise{La región encerrada por la semicircunferencia $x^{2}+y^{2}=4,y\geq 0$
  $\ $con función de densidad $\rho \left( x\right) =x^{2}.$}{$m=2\pi ,$ \ Centro de masa $\left( 0,0.67906\right) .$}

  \exercise{La región limitada por $y=e^{x},y=e^{-x}$ y $x=\ln 3$ con funció%
  ...
  \exercise{Un tanque en forma de prisma rectangular con un largo de $6$ pies, ancho de
    $4$ pies y alto de $10$ pies, está lleno de agua. Encuentre el trabajo
  realizado para bombear toda el agua hasta la parte superior del tanque.}{$149760$ lb-pie.}

  \exercise{Un tanque en forma de pirámide con base cuadrada de lado $5$ pies y
  ...
  de la parte superior del tanque.}{$31200$ lb-pie.}

  \exercise{ Un tanque en forma de cono circular recto con radio de la base de $6$ pies
    y altura de $14$ pies con el vértice hacia abajo, está lleno de agua
    hasta una profundidad de $8$ pies. \ Encuentre el trabajo realizado para
    bombear el agua hasta una altura de $3$ pies arriba de la parte superior del
  tanque.}{$\frac{5271552}{245}\pi $ lb-pie.}
  ...
  bombear toda el agua hasta 1 pie arriba de la parte superior del tanque.}{$197600\pi lb-pie.$}

  \exercise{Un tanque parabólico, generado por el giro de la recta $y=\frac{1}{2}x^{2}$, $0\leq x\leq 2$, ($x$ en pies ) alrededor del eje $y$, está lleno de
    agua. Hallar el trabajo realizado para bombear el agua hasta 1 pie por
  encima del tanque.}{$416\pi $ lb-pie.}

  \exercise{El tanque, generado por el giro de la recta $y=x^{3}$, $0\leq x\leq 2$, ($x$ en pies ) alrededor del eje $y$, está lleno de agua. Hallar el trabajo
  realizado para bombear el agua hasta $2$ pies por encima del tanque.}{$\frac{29952}{5}\pi $ lb-pie}

  \exercise{El tanque, generado por el giro de la recta $y=x^{4}$, $0\leq x\leq 2$, ($x$ en pies ) alrededor del eje $y$, está lleno de agua. Hallar el trabajo
  realizado para bombear el agua hasta $1$ pie por encima del tanque.}{$\frac{492544}{25}\pi $ lb-pie}

  \exercise{Una placa rectangular plana de $20$ pies por $26$ pies se sumerge
    horizontalmente en agua a una profundidad de $15$ pies. Determine la presi%
  ón y la fuerza ejercidas sobre la placa por el agua arriba de ésta.}{$486720$ lb.}
  ...
  ón y la fuerza ejercidas sobre la placa por el agua arriba de ésta.}{$150555.525$ lb.}

  \exercise{La placa formada por un rectángulo de base $6$ pies y altura $10$ pies se
    sumerge verticalmente en agua, hasta que la base coincida con el nivel del
  agua. Encuentre la fuerza ejercida por el agua sobre un lado de la placa.}{$18720$ lb.}

  \exercise{La placa formada por un triángulo isóceles de base $8$ pies y
  ...
  \exercise{La placa formada por el sector parabólico limitado por $y=x^{2}$ y la
    recta $y=9.$ ($x$ en pies) se sumerge verticalmente en agua, hasta que la
    recta $y=11$coincida con el nivel del agua. Encuentre la fuerza ejercida por
  el agua sobre un lado de la placa.}{$8087.04$ lb.}

  \exercise{Una placa en forma de mitad de un disco de radio $3$ pies se sumerge
    verticalmente en agua, hasta que el diámetro coincida con el nivel del agua.
  Encuentre la fuerza ejercida por el agua sobre un lado de la placa.}{$1123.2$ lb.}

  \exercise{Una placa en forma de triángulo equilátero de lado $5$ pies con la base
    horizontal se sumerge verticalmente en agua, hasta que la base coincida con
    el nivel del agua. Encuentre la fuerza ejercida por el agua sobre un lado de
  la placa.}{$195$ lb.}

  \exercise{La placa formada por la región limitada por $y=x^{2}-1$ y $y=7-x^{2}.$
    ($x$ en pies) se sumerge verticalmente en agua, hasta que el vértice de $%
    y=7-x^{2}$ sea tangente al nivel del agua. Encuentre la fuerza ejercida por
  el agua sobre un lado de la placa.}{$5324.8$ lb.}

  \exercise{La placa formada por la región limitada por $y=4-x^{2}$ y $y=4-4x.$ ($%
    x$ en pies) se sumerge verticalmente en agua, de tal forma que el nivel del
    agua corresponde con la recta $y=8$. Encuentre la fuerza ejercida por el
  agua sobre un lado de la placa.}{$1297.92$ lb.}

  \exercise{La placa formada por la región limitada por $y=\sen x$ y $y=0,0\leq
    x\leq \pi$. ($x$ en pies) se sumerge verticalmente en agua, de tal forma
    que el nivel del agua coincida con la recta $y=2$. Encuentre la fuerza
  ejercida por el agua sobre un lado de la placa.\label{masafin}}{$93.462$ lb.}
