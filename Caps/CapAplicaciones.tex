...
\exercise {$y=2x^{3}-3x^{2}-9x$ y $ y=x^{3}-2x^{2}-3x$}{}

\exercise {La región en el primer cuadrante acotada por $y=x^{-2}$, $y=8x$ y  $y=\frac{x}{8}$}{}

\exercise {La región en el primer cuadrante acotada por $y=9-x^{2},\ y=8x$ y $y=\frac{5}{2}x$}{}

\exercise {Halle el area de la región limitada por la hipérbola dada por la ecuación $9x^{2}-4y^{2}=36$ y la recta vertical $x=3$.\label{areafinal}}
%\end{multicols}
...
{$L=\frac{1}{27}\left[ (-5+9(2))^{\frac{3}{2}}\right.$\linebreak$\left.-(-5+9(1))^{\frac{3}{2}%
}\right] u$}
...
\begin{multicols}{2}
\subexercise{$y=\sqrt{x},4\leq x\leq 9. $} {$S=\frac{\sqrt{2}\pi }{3}\left( 19(19)^{\frac{1}{2}}\right.$\linebreak$\left.-27\right) u^{2}$}

\subexercise{$y=x+4,0\leq x\leq 2.$} {$ S=10\sqrt{2}u^{2}$}

\subexercise{$y^{2}=4x+4.$} {$S= \frac{16\sqrt{2}\pi }{3}\left( 5\sqrt{5}-1\right) u^{2}$}

\subexercise{$y=x^{3},0\leq x\leq 2.$} {$S=\frac{1}{54}\left( 145(145)^{\frac{1}{2}}\right.$\linebreak$\left.-1\right) u^{2}$}
...
\subexercise{$x=2\ln y,1\leq y\leq 2.$} {$S=2\pi \left( 4\sqrt{2}+4\ln \left( 2\sqrt{2}+2\right) -\sqrt{5}\right.$\linebreak$\left.-4\ln  \left( \sqrt{5}+1\right) \right) u^{2}$}
\end{multicols}
