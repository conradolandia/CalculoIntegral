...
\begin{align*}
  ...
  + 3\left( \frac{u^{2}+1}{u^{2}+1} \right)} \, du \\ \displaybreak
...
\begin{multicols}{2}
  ...
  \exercise{$\int \cot ^{10}\theta d\theta$}{$-\frac{1}{9}\cot ^{9}\theta$ \linebreak $+\frac{1}{7}\cot ^{7}\theta -\frac{1}{5}\cot ^{5}\theta +\frac{1}{3}\cot^{3}\theta -\cot \theta -\theta +C$}
...
\begin{multicols}{2}
  ...
  \exercise{${\int \cos x\ln (\sen x)\, dx}$}{$\left( \sen x\right) \left( \ln \left( \sen x\right)\right.$\linebreak $\left. -1\right) $}
  ...
  \exercise{${\int e^{\sqrt[3]{x}}\, dx}$}{\linebreak$3e^{\sqrt[3]{x}}\left( \sqrt[3]{x}^{2}-2\sqrt[3]{x}+2\right) $}

  \exercise{${\int \sen (\ln x)\, dx}$}{$\frac{1}{2}x\left( \sen \left( \ln x\right) -\cos\left( \ln x\right) \right) $}

  \exercise{${\int x\sen (\sqrt{x})\, dx}$}{ $6x\sen \sqrt{x}-2\sqrt{x}^{3}\cos \sqrt{x}$\linebreak $-12\sen \sqrt{x}+12\sqrt{x}\cos \sqrt{x}+C$}
  ...
  \exercise{${\int \cos \left( \ln t\right) dt}$}{$\frac{1}{2}t \left(\cos\ln t\right.$ \linebreak $\left. +\sen\ln t\right) $}
  ...
  \exercise{${\int \cot ^{5}x\sen ^{2}x\, dx}$}{$-\frac{1}{2\sen ^{2}x}\times$ \linebreak $\left( 4\sen ^{2}x\ln\sen x-\sen ^{4}x+1\right) $}
  ...
  \exercise{${\int e^{\sqrt[4]{x}}\, dx}$}{$-4e^{\sqrt[4]{x}}\times$ \linebreak $\left( -\sqrt[4]{x}^{3}+3\sqrt[4]{x}^{2}-6\sqrt[4]{x}+6\right) $ }

  \exercise{${\int x\ln ^{3}x\, dx}$}{$\frac{1}{8}x^{2}\left( 4\ln ^{3}x-6\ln ^{2}x+6\ln x-3\right) $}

  \exercise{${\int_{1}^{e}\ln ^{4}x\, dx}$}{$\allowbreak 9e-24$ }

  \exercise{${\int \left( x^{4}+x^{2}\right) \ln x\, dx}$}{\linebreak$-\frac{1}{225}%
  ...
  \exercise{${\int \arcsen^{2}x\, dx}$}{\linebreak $2\left(\arcsen x\right) \sqrt{1-x^{2}}-2x+x\arcsen ^{2}x$ }

  \exercise{${\int x\arctan x\, dx}$}{$ \frac{1}{2}\tan^{-1} x-\frac{1}{2}x-\frac{1}{%
  4}\pi +\frac{1}{2}x^{2}\tan^{-1} x$}

  \exercise{${\int x\sec^{-1} x\, dx}$}{$\frac{1}{2}\left(x^{2}\sec^{-1}\right.$ \linebreak $\left. x-%
  \sqrt{x^{2}-1}\right) $ }
  ...
  \exercise{${\int \frac{x}{\sqrt{\left( x+1\right) ^{2}+9}}dx}$}{$\sqrt{\left( x+1\right)^{2}+9}-\ln \left\vert \frac{1}{3}\sqrt{\left( x+1\right)^{2}+9}\right.$ \linebreak$\left.+\frac{x+1}{3}\right\vert +C$}
  ...
  \exercise{${\int \frac{1}{\sqrt{9x^{2}+6x-8}}\, dx}$}{$\frac{1}{3}\ln \left( 18x\right.$ \linebreak$\left.+6\sqrt{9x^{2}+6x-8}+6\right) $}

  \exercise{${\int \frac{1}{\left( x^{2}+4x+5\right) ^{2}}dx}$}{$\frac{%
  1}{2}\left( \arctan \left( x+2\right) +\frac{x+2}{x^{2}+4x+5}\right) +C$}

  \exercise{${\int \frac{1}{(5-4x-x^{2})^{\frac{5}{2}}}\, dx}$}{$-\frac{1}{243\left(-x^{2}-4x+5\right)^{\frac{3}{2}}}\left( 2x^{3}+\right.$ \linebreak$\left.12x^{2}-3x-38\right)$}
  ...
  \exercise{${\int \frac{x^{3}}{(x+2)^{4}}\, dx}$}{$\frac{1}{3\left( x+2\right) ^{3}}\left(54x+\right.$ \linebreak$\left.24\ln \left( x+2\right) +36x\ln \left( x+2\right) \right.  \left.+18x^{2}\ln \left(
  x+2\right) +3x^{3}\ln \left( x+2\right) +18x^{2}+44\right)$}

  \exercise{${\int \frac{1}{x^{4}-x^{2}}\, dx}$}{\linebreak$\frac{1}{2x}\left( x\ln \left( x-1\right)-x\ln \left( x+1\right) +2\right) $}
  ...
  \exercise{${\int_{0}^{1}\frac{8x^{2}}{x^{4}-16}\, dx}$}{\linebreak$\pi -\ln 3-2\arctan 2$}
  ...
  x-2}$}{\linebreak$\ln \left\vert \frac{\sqrt[4]{2\tan (\frac{x}{2})+1}}{\tan (\frac{x}{2})}\right\vert +C$}
  ...
  \exercise{$\int \frac{dx}{2\sen x+\sen 2x}$}{$\frac{1}{4}\left[\ln \left\vert\tan(\frac{x}{2})\right\vert\right.$ \linebreak$\left.+\frac{\tan^{2}(\frac{x}{2})}{2}\right] +C$}
  ...
  \exercise{$\int \frac{dx}{15\sen x+8\cos x+17}$}{$\linebreak\frac{-2}{9\tan (\frac{x}{2})+15}+C$}
\end{multicols}
