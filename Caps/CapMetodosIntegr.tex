...
\begin{ejemplo} \textnormal{Usemos las propiedades anteriores para polinomios en intervalos simétricos.}
\end{ejemplo}
\begin{align*}
...
\begin{ejemplo} \textnormal{Encontremos el valor de} $\displaystyle{\int\frac{\sqrt{4+x^{2}}}{x}dx}$.
\end{ejemplo}
...
\begin{ejemplo} \textnormal{Hallemos el valor de} $\displaystyle{\int_{0}^{1}\frac{x^{2}}{\sqrt{1+x^{2}}^{\,3}}dx}$.
\end{ejemplo}
...
\begin{ejemplo} \textnormal{Encontremos el valor de} $\displaystyle{\int\frac{dx}{\sqrt{x^{2}-9}}}$.
\end{ejemplo}
...
\begin{ejemplo} \textnormal{Encontremos el valor de} {\small $\displaystyle{\int e^{t} \sqrt{e^{2t}-100}dt}$.}
\end{ejemplo}
...
\begin{ejemplo}
Calcule $\displaystyle\int \frac{dx}{\sen x+3\cos x-1}$.
\end{ejemplo}
...
\begin{ejemplo}
Calcule $\displaystyle\int \frac{dx}{\sen x-3\cos x+3}$.
