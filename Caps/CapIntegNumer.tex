...
\begin{figure}[t]
  ...
  \includegraphics[width=6cm]{Gráficas/IntegImprIntervDerech}
  \propia
\end{figure}
...
\begin{figure}[H]
  ...
  \includegraphics[width=6cm]{Gráficas/IntegImprIntervIzqu}
  \propia
\end{figure}
...
\begin{figure}[H]
  ...
  \includegraphics[width=5cm]{Gráficas/IntegImprDisconLimferior}
  \propia
\end{figure}
...
\begin{figure}[H]
  ...
  \includegraphics[width=6cm]{Gráficas/IntegImprDisconLimSuperior}
  \propia
\end{figure}
...
\begin{figure}[H]
  ...
  \includegraphics[width=6cm]{Gráficas/IntegImprDisconIntervalo}
  \propia
\end{figure}
...
\emph{Solución.} En este caso, tenemos una discontinuidad en un punto del intervalo. El integrando es discontinuo en $x=0$, que está en el intervalo $[-1,1]$:
\begin{gather*}
  \begin{aligned}
    ...
    &=\lim_{c\rightarrow 0^{-}}\left( \int \frac{dx}{x^{\frac{2}{3}}}\right)\Bigg|_{-1}^{c}+\lim_{z\rightarrow 0^{+}}\left(\int \frac{dx}{x^{\frac{2}{3}}}\right)\Bigg|_{z}^{1}\\
...
\begin{figure}[H]
  ...
  \includegraphics[width=9cm]{Gráficas/rtrapecio}
  \propia
\end{figure}
...
\begin{align*}
  ...
  &\quad+\frac{h}{3}\left[f(x_{2})+4f(x_{3})+f(x_{4})\right]
  +\frac{h}{3}\left[f(x_{4})+4f(x_{5})+f(x_{6})\right] +\ldots \\
  &\quad+\frac{h}{3}\left[ f(x_{n-2})+4f(x_{n-1})+f(x_{n})\right] \displaybreak \\
  &=\frac{h}{3}\left[f(x_{0})+4f(x_{1})+2f(x_{2})+4f(x_{3})\right.\\
  &\quad\left.+f(x_{4})+4f(x_{5})+f(x_{6})+\ldots+f(x_{n-2})+4f(x_{n-1})+f(x_{n})\right] \\
  &=\frac{h}{3}\left[f(x_{0})+4f(x_{1})+2f(x_{2})+4f(x_{3})\right.\\
    &\quad+2f(x_{4})+4f(x_{5})+2f(x_{6})+\ldots\\
  &\quad\left.+2f(x_{n-2})+4f(x_{n-1})+f(x_{n})\right]
\end{align*}
...
\item Usando el método de Simpson, halle el área de la región dada en la figura~\ref{fig:InteNumSimpsEjemp}:
  ...
  \begin{figure}[H]
    ...
    \includegraphics[width=0.45\textwidth]{Gráficas/InteNumSimpsEjemp}
    \propia
  \end{figure}
