...
De la integral dada tenemos que $f(x)=\cfrac{1}{1+x^{4}}$; $\Delta x=\cfrac{3-0}{6}=\cfrac{3}{6}=\cfrac{1}{2}$, y la partición es
{\small
  \[
...
\begin{enumerate}
  ...
  \item {$\int_{0}^{\infty }e^{-x}\sin x\,dx$} {Converge a $\frac{1}{2}$.}
  ...
  \item {$\int_{0}^{1}x\ln x\,dx$} {Converge a $-\frac{1}{4}$}
