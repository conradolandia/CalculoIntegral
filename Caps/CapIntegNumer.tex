...
\item $\int_{0}^{3}\frac{1}{1+x^{4}}dx$ con $n=6$.
  ...
  \begin{gather*}
    \begin{aligned}
      ...
      &=(0.1666)(6.6542) \approx\allowbreak
      1.106
    \end{aligned}
  \end{gather*}
...
\begin{multicols}{3}
  ...
  \exercise{$\int_{0}^{\infty }e^{-x}\sin xdx$.} {Converge a $\frac{1}{2}$}
  ...
  \exercise{$\int_{1}^{\infty }\frac{1}{x}dx$.} {Diverge.}
  ...
  \exercise{$\int_{0}^{1}x\ln xdx$.} {Converge a $-\frac{1}{4}$.}

  \exercise{$\int_{0}^{\infty }\frac{1}{\left( 1+x\right) \sqrt{x}}dx$.} {Converge a $\pi$.}

  \exercise{$\int_{0}^{e}\ln ^{2}zdz$.} {Converge a $e$.}
\end{multicols}

\exercise{Aproxime las siguientes integrales usando el método del punto medio, la regla del trapecio y método de Simpson, con el valor de $n$ indicado.}
%\begin{multicols}{2}
\subexercise{$\int_{2}^{4}\frac{x}{\ln x}dx$  con $n=6$.}{$M_{6}=5.5483,\ T_{6}=5.5598,\ S_{6}=5.552\,5$}
...
\subexercise{Para aproximar $\int_{4}^{10}f\left( x\right) dx$ usando la regla del
trapecio.}{$S_{12}=26.7$}

\subexercise{Si $-5\leq f^{\left( 4\right) }\left( x\right) \leq 10$ para todo $x\in %
\left[ 4,10\right] $. \ Estime el error en la aproximación de la parte
a).}{Error $0.00837$}

\exercise{}

\subexercise{Halle $n$ para que $\int_{0}^{1}e^{\frac{1}{4}x^{2}}dx$ tenga magnitud de error menor que $10^{-3},$ usando la regla del trapecio y halle $T_{n}$.}{$n=10$\qquad $T_{10}=1.090\,5$.}
