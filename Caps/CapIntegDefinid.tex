...
\begin{ejemplo}
  Si vamos a sumar los números del $1$ al $12$, es decir,
  \[
...
\begin{align*}
  ...
  &=\frac{152\left(152+1\right)}{2}=76\times 153=11\,628
\end{align*}
...
\textit{Demostración}. Usemos inducción\footnote{Para recordar sobre inducción matemática, puede consultarse \textcite{Stewart_2012}, páginas 814-819.} sobre $m$.
...
\item \textls[-10]{Supongamos ahora que el resultado es válido para todo número natural menor o igual a $m$ y probemos que también es válido para $m+1$: por un lado, por la propiedad telescópica de las sumas, tenemos que}
  ...
  \end{equation}
  y por otro lado, usando el teorema del binomio\footnote{Puede consultarse \textcite{Stewart_2012}, páginas 820-827.},
...
\begin{ejemplo} \textbf{Suma geométrica.} Supongamos que $n$ es un número natural y que $b$ es un número real distinto de $1$. Entonces
\[
...
\frac{3}{5}=\frac{3}{5}\\[0.5em]
\Delta x_{3}&=\frac{8}{5}-\frac{6}{5}=\frac{2}{5} &\Delta x_{4}&=2-\frac{8}{5}=\frac{2}{5}\\[0.5em]
...
\Delta x_{2}&=-1+\frac{7}{5}=\frac{2}{5}\\[0.5em]
\Delta x_{3}&=\frac{-4}{5}+1=\frac{1}{5} &
\Delta x_{4}&=\frac{-1}{5}+\frac{4}{5}=\frac{3}{5} \displaybreak\\
\Delta x_{5}&=\frac{3}{5}+\frac{1}{5}=\frac{4}{5} &
\Delta x_{6}&=\frac{6}{5}-\frac{3}{5}=\frac{3}{5}\\[0.5em]
\Delta x_{7}&=\frac{8}{5}-\frac{6}{5}=\frac{2}{5}&
\Delta x_{8}&=2-\frac{8}{5}=\frac{2}{5}\\[0.5em]
...
\begin{center}
\textbf{Función de la parte entera}
...
La figura~\ref{fig:graf7} muestra la función por integrar.
...
-1,-0.5,-0.8,0,0.5,1\right\}$, partición de $\left[ -1,1\right]$; use el extremo derecho.}{$1.2506$}
...
\subexercise{$f\left( x\right) =x^{4}-1$ \ \ $P=\left\{ -1,-0.5,0,0.5,1,2,3\right\} $, partición de $\left[ -1,3\right]$; use el extremo izquierdo.}{$13.563$}

\subexercise{$f\left( x\right) =20-4x^{2}$ \ $P=\left\{
0,0.5,1.5,1.8,2,2.5,3\right\} $, partición de $\left[ 0,3\right]$; use el punto medio.}{$24.47$}

\subexercise{$f\left( x\right) =x^{3}-1$ \ $P=\left\{
-1,-0.5,0,0.5,1,2,3,3.6,4\right\} $, partición de $\left[ -1,4\right]$; use el punto medio.}{$57.51$}

\subexercise{$f\left( x\right) =2^{x}-1$ \ $P=\left\{
0,0.5,1,2.5,3,3.6,4.1,5\right\} $, partición de $\left[ 0,5\right]$; use el extremo derecho.}{$53.842$}

\exercise{Calcule cada una de las siguientes integrales usando la definición:}
\begin{multicols}{3}
\subexercise{$\int_{0}^{2}\left( x^{2}-2\right) dx$}{$-\frac{4}{3}$}

\subexercise{$\int_{0}^{1}\left(x^{2}-x\right) dx$}{$-\frac{1}{6}$}

\subexercise{$\int_{-1}^{1}x^{3}dx$}{$0$}

\subexercise{$\int_{-2}^{2}\left( x^{3}+2\right) dx$}{$8$}

\subexercise{$\int_{-1}^{2}\left( 2x^{3}-1\right) dx$}{$\frac{9}{2}$}

\subexercise{$\int_{0}^{2}\left(2^{x}\right) dx$}{$\frac{3}{\ln 2}$}

\subexercise{$\int_{0}^{3}2\left( 3^{x}\right) dx$}{$\frac{52}{\ln 3}$}
\end{multicols}

\exercise{Calcule usando las propiedades de la integral:}
\begin{multicols}{2}
\subexercise{$\int_{0}^{2}\left( 4x^{3}-8x^{2}+7x+8\right) dx$}{$\frac{74}{3}$}

\subexercise{$\int_{-2}^{1}\left( 5x^{3}-7x^{2}+4x-3\right) dx$}{$-\frac{219}{4}$}

\subexercise{$\int_{-2}^{2}\left( x^{4}+2x^{3}-x+1\right) dx$}{$\frac{84}{5}$}

\subexercise{$\int_{-1}^{2}\left( 2x^{5}-10x^{3}\right) dx$}{$-\frac{33}{2}$}

\subexercise{$\int_{0}^{3}\left( e^{x}+2^{x}+3\right) dx$}{ $e^{3}+\frac{7}{\ln 2}+8$}

\subexercise{$\int_{0}^{3}\left( 4^{x}+3^{x}+3x\right)\,dx$}{$\frac{63}{2\ln 2}+\frac{26}{\ln 3}+\frac{27}{2}$}

\subexercise{$\int_{0}^{3}\left(5^{x}+4^{x}+4x^{2}\right) dx$}{$\frac{63}{2\ln 2}+\frac{124}{\ln 5}+36$}

\subexercise{$\int_{-1}^{2}\left\vert x\right\vert dx$}{$\frac{5}{2}$}

\subexercise{$\int_{-1}^{4}\left\vert x^{2}-2x-3\right\vert dx$}{$13$}

\subexercise{$\int_{-4}^{4}\left\vert x^{2}-9\right\vert dx$}{$\frac{128}{3}$}

\subexercise{$\int_{-1}^{2}\left[ \left\vert x\right\vert \right] dx$}{$0$}

\subexercise{$\int_{1}^{4}\left[ \left\vert 2x\right\vert \right] dx$}{$13.5$}

\subexercise{$\int_{-1}^{4}\left[ \left\vert 3x\right\vert \right] dx$}{$20$}

\subexercise{$\int_{0}^{4}\left[ \left\vert x^{2}\right\vert \right] dx$}{$19.531$}

\subexercise{$\int_{0}^{2}\left[ \left\vert 2x^{2}\right\vert \right] dx$}{$4.47$}

\subexercise{$\int_{0}^{2}\left[ \left\vert x^{3}\right\vert \right] dx$}{$3.27$}
\end{multicols}

\subexercise{$\int_{-2}^{2}f(x)\,dx$, si $f(x)=\left\{
\begin{array}{ll}
x^{2}-4, & \text{ si }x<0 \\
...
\subexercise{$\int_{-1}^{3}f(x)\,dx$, si $f(x)=\left\{
\begin{array}{ll}
...
\subexercise{$\int_{-2}^{3}f(x)\,dx$, si $f(x)=\left\{
\begin{array}{ll}
  x^{2}-4x, & \text{ si }x<0 \\
...
\subexercise{$f(x)=\left\{
  ...
  \end{array}%
\right.$\hspace{-0.3em}, $x=0$, $x=6$ y el eje $x$}{$\frac{182}{3}$}

\subexercise{$f(x)=\left\{
    \begin{array}{ccc}2\sen x & \text{si} & x\geq 0 \\ 3\cos x & \text{si} & x<0%
    \end{array}%
  \right.$\hspace{-0.3em}, $x=-\frac{^{\pi }}{2}$, $x=\frac{\pi }{4}$ y el eje $x$}{$5-\sqrt{2}$}

  \subexercise{$f(x)=\left\{
      \begin{array}{ccc}2^{x} & \text{si} & x<-1 \\ \frac{1}{2^{x}} & \text{si} & x\geq -1%
      \end{array}%
    \right.$\hspace{-0.3em}, $x=-2$, $x=2$ y el eje $x$}{$\frac{2}{\ln 2}$}
    ...
    \subexercise{$f(x)=\left\{
      ...
      \setlength{\arraycolsep}{3pt}
        ...
        \end{array}%
      \egroup
      \right.$\hspace{-0.45em}, $x=-1$, $x=4$ y el eje $x$}{$e^{4}-e^{\pi}+14$}
      ...
      \begin{multicols}{2}
        ...
        \subexercise{$\int_{1}^{25}\log _{5}x\,dx$}{$50-\frac{24}{\ln 5}$}
        ...
        \subexercise{$\int_{0}^{1}\arccose\, \left( 1-x\right)\,dx$}{$1$}
