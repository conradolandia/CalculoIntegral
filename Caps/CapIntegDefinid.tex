...
\underset{k=1}{\sum }}f(x_{k})\Delta x_{k} =\underset{n\rightarrow \infty }{\lim }\sum_{k=1}^{n}
...
{\small
\begin{align*}
&\int_{-2}^{2}(3x^{2}-x+3)\,dx=\underset{n\rightarrow \infty }{\lim }\sum_{k=1}^{n}f(x_{k})\Delta x_{k} \\
&=\underset{n\rightarrow \infty }{\lim }\sum_{k=1}^{n}
