...
\textbf{Caso I.} Supongamos que $f$ es una función continua en el intervalo $[a,\infty ).$ La integral impropia $\displaystyle\int_{a}^{\infty }f\left( x\right) dx$ se evalúa de la siguiente manera:
\[
...
%\end{center}
\vskip0.3cm
\textbf{Caso II.} Sea $f$ una función continua en $(-\infty ,b].$ La integral impropia $\displaystyle\int_{-\infty }^{b}f\left( x\right) dx$ se evalúa de la siguiente manera:
\[
...
%\end{center}
\vskip0.2cm
\textbf{Caso III.} Sea $f$ \ una función continua en $(-\infty ,\infty ).$ La integral impropia $\displaystyle\int_{-\infty }^{\infty }f\left( x\right) dx$ es
{\small
\[
...
\end{ejemplo}
\textit{Solución.} Inicialmente, calculamos la integral usando alguno de los métodos que ya hemos estudiado. En este caso, planteamos fracciones parciales para calcularla:
{\small
\[
...
\end{ejemplo}
\textit{Solución.} Escribamos esta vez en la forma de la definición dada:
{\small
\begin{align*}
...
\end{ejemplo}
\textit{Solución.} Igual que en el ejemplo anterior,
{\small
\begin{align*}
...
\begin{ejemplo}\sl
\textnormal{Diga si la integral \textit{$\displaystyle \int_{1}^{\infty }\frac{8}{x^{3}+x}dx$} converge o diverge. Si converge, diga a qué valor lo hace.}
\end{ejemplo}
\textit{Solución.} Para calcular la integral, usemos sustitución trigonométrica:
{\small
\[
...
\begin{ejemplo}\sl
\textnormal{Diga si la integral \textit{$\displaystyle\int_{2}^{\infty }\frac{x}{x^{4}-1}dx$} converge o diverge. Si converge, diga a qué valor lo hace.}
\end{ejemplo}
\textit{Solución.} Si reescribimos la integral y hacemos la sustitución $y=x^2$, tenemos
\[
...
\begin{ejemplo}\sl
\textnormal{Diga si la integral \textit{$\displaystyle \int_{3}^{\infty}\frac{x}{x^{4}+3x^{2}-4}dx$} converge o diverge. Si converge, diga a qué valor lo hace.}
\end{ejemplo}
\textit{Solución.} Reescribamos el integrando y tomemos la sustitución $y=x^2$:
\begin{align*}
...
\begin{ejemplo}\sl
\textnormal{Diga si la integral {\small\textit{$\displaystyle\int_{1}^{\infty }\frac{dx}{e^{x+2}+e^{4-x}} $}} converge o diverge. Si converge, diga a qué valor lo hace.}
\end{ejemplo}
\textit{Solución.} Al reescribir la integral, tenemos
\begin{align*}
...
\begin{ejemplo}\sl
\textnormal{Diga si la integral {\small \textit{$\displaystyle\int_{2}^{\infty }\frac{x^{2}}{\left( x^{2}+4\right) ^{2}}dx$}} converge o diverge. Si converge, diga a qué valor lo hace.}
\end{ejemplo}

\vskip0.2cm
\textit{Solución.} Tomemos $x=2\tan \theta$ y $dx=2\sec ^{2}\theta d\theta$, además $x^{2}+4=4\tan^{2}\theta +4=4\left( \tan ^{2}\theta +1\right) =4\sec ^{2}\theta $, entonces
...
\begin{ejemplo}\sl
\textnormal{Diga si la integral {\small \textit{$\displaystyle \int_{1}^{\infty }\frac{4}{x\left( x+1\right) ^{2}}dx$}} converge o diverge. Si converge, diga a qué valor lo hace.}
\end{ejemplo}

\vskip0.2cm
\textit{Solución.} Al descomponer en fracciones parciales el integrando, se tiene
{\small
\[
...
Otro caso de integrales impropias se tiene cuando el integrando es una función con discontinuidad infinita (as\'{\i}ntota vertical) en el intervalo de integración.

\textbf{Caso I.} Sea $f$ una función continua en el intervalo $(a,b]$ y supongamos que $x=a$ es una as\'{\i}ntota vertical de $f$. Entonces, la integral {\small $\displaystyle\int_{a}^{b}f\left( x\right) dx$} es impropia y, para calcularla, se procede con el siguiente límite:
\[
...
%\end{center}
\vskip0.2cm
\textbf{Caso II.} Supongamos que $f$ es una función continua en $[a,b)$ y que $x=b$ es una as\'{\i}ntota vertical de $f$. La integral impropia {\small $\displaystyle\int_{a}^{b}f\left( x\right) dx$} se define como
{\small
\[
...
%\end{center}
\vskip0.3cm
\textbf{Caso III.} Sea $f$ una función continua en $[a,b]-\left\{ c\right\} $, para c$\in\left( a,b\right)$, y $x=c$ es una as\'{\i}ntota vertical de $f$. La integral impropia {\small $\displaystyle\int_{a}^{b}f\left( x\right) dx$} se define como
...
\textit{Solución.} En este caso, tenemos una discontinuidad en el límite superior para el integrando; entonces,
...
\textit{Solución.} En este caso, tenemos una discontinuidad en un punto del intervalo. El integrando es discontinuo en $x=0$, que está en el intervalo {\small $[-1,1]$:}
...
f^{\prime}\right\vert $ en $\left[ a,b\right] $, entonces el error en el método del punto medio {\small $E_{m}=\displaystyle\int_{a}^{b}f(x)dx-M_{n}$} satisface
\[
\left\vert E_{m}\right\vert \leq \frac{\left( b-a\right) ^{3}}{24n^{2}}M
\]

\begin{ejemplo}\sl
\textnormal{Halle una aproximación de la integral, con $n=5$ para \textit{$\int_{0}^{5}x^{3}dx,$} usando el método del punto medio.}
\end{ejemplo}
...
\textit{Solución.} Según la fórmula del método, tenemos
...
\begin{figure}[htbp]
    \centering
    \caption{Par?bolas en la regi?n por medir}
    \includegraphics[width=0.40\textwidth]{Gráficas/simpson.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{ejemplo}\sl
\textnormal{Utilice el método de Simpson para estimar cada una de las siguientes integrales con la información dada.}
\end{ejemplo}
...
\textit{Solución.} En este caso tenemos que $\Delta x=\cfrac{2-1}{4}=\cfrac{1}{4}$ \ y
{\small
\[
...
\textit{Solución.} Ahora, $\Delta x=\cfrac{3-0}{6}=\cfrac{3}{6}=\cfrac{1}{2}$ \ y
...
%\end{center}
\vskip0.3cm
\textit{Solución.} Con la información en la figura, podemos hacer


\resizebox{\textwidth}{!}{$
	\begin{aligned}
\text{área}&\approx S_{8}=\frac{1\text{,}8}{3}\Big( 2+4\cdot 2\text{,}5+2\cdot 3\text{,}1+4\cdot 3\text{,}8+2\cdot4+4\cdot 4\text{,}5
%\\ &\quad
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.45\textwidth]{Gráficas/ejempintnum.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\item {Use la tabla para aproximar $\displaystyle\int_{0}^{5}f\left( x\right) dx$ usando el método del punto medio.}{$M_{5}=11,2$}
...
\item {Halle $n$ para que $\displaystyle\int_{0}^{1}e^{\frac{1}{4}x^{2}}dx$ tenga magnitud de error menor que $10^{-4},$ usando el método de Simpson y halle $S_{n}.$}\\
