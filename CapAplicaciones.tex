...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.30\textwidth]{Gráficas/GrafAreaEntreCurvFx.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.38\textwidth]{Gráficas/GrafAreaEntreCurvFy.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.35\textwidth]{Gráficas/GrafAreaEntreCurvFG.eps}
    \vspace{0.3em}
    \propia
\end{figure}
\vskip0.2cm
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.30\textwidth]{Gráficas/GrafAreaEntreCurv1.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.30\textwidth]{Gráficas/GrafAreaEntreCurv2.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.30\textwidth]{Gráficas/GrafAreaEntreCurv3.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.30\textwidth]{Gráficas/GrafAreaEntreCurv4.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \caption{Región cuya área se va a medir}
    \includegraphics[width=0.35\textwidth]{Gráficas/GrafAreaEntreCurv5.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \caption{Región cuya área se va a medir}
    \includegraphics[width=0.38\textwidth]{Gráficas/GrafAreaEntreCurv6.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.36\textwidth]{Gráficas/GrafAreaEntreCurv7.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.36\textwidth]{Gráficas/SeccTransCono.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.36\textwidth]{Gráficas/SeccTransPiramide.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.36\textwidth]{Gráficas/SeccTransDefinic.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.30\textwidth]{Gráficas/GrafArTransvBaseTriang1.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.36\textwidth]{Gráficas/GrafArTransvBaseTriang2.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.56\textwidth]{Gráficas/GrafArTransvBaseTriang3.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{ejemplo}\sl
\textnormal{Encuentre el volumen del sólido cuya base es la región limitada por \textit{$y=4-x^{2}$} y el eje \textit{$x$}, y cuyas secciones transversales perpendiculares al eje \textit{$x$} son cuadrados con un lado sobre su base.}
\end{ejemplo}
\vskip0.2cm
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.55\textwidth]{Gráficas/GrafArTransvBaseParabola.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.56\textwidth]{Gráficas/GrafArTransvBaseParSolid.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.47\textwidth]{Gráficas/GrafCono.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.55\textwidth]{Gráficas/GrafEsferaCortes.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
%\end{center}
\vskip0.2cm
Es decir, el radio del corte tranversal es $y=\sqrt{r^2-x^2}$; as\'{\i}, el área del círculo es $A(x)=\pi y^{2}=\pi (r^{2}-x^{2})$ y entonces el volumen $V$ de la esfera es
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.47\textwidth]{Gráficas/ConoTruncado.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.25\textwidth]{Gráficas/CasqueteEsferico.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.38\textwidth]{Gráficas/CasqueteEsfericoEnPlano.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.38\textwidth]{Gráficas/SeccTransElipTriangBase.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \caption{Secciones transversales}
    \includegraphics[width=0.65\textwidth]{Gráficas/SeccTransElipTriang.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \caption{El sólido}
    \includegraphics[width=0.65\textwidth]{Gráficas/SeccTransElipTriangSolid.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.35\textwidth]{Gráficas/Reg4LnxXlnx.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.45\textwidth]{Gráficas/SeccTrans4LnxXlnx.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption{El sólido}
    \label{fig:solido_}
    \includegraphics[width=0.45\textwidth]{Gráficas/SeccTrans4LnXlnSolid.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.54\textwidth]{Gráficas/SolRevIntroducc.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption{La región $R$}
    \label{fig:la_region}
    \includegraphics[width=0.40\textwidth]{Gráficas/SolRevRegiDefin.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.25\textwidth]{Gráficas/SolRevDefin.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.28\textwidth]{Gráficas/SolRevSeccTransDefin.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.63\textwidth]{Gráficas/SolRevDiscEjemRect.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.35\textwidth]{Gráficas/SolRevDiscEjemRectDiscos.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.46\textwidth]{Gráficas/SolRevDiscEjemTang.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.35\textwidth]{Gráficas/SolRevDiscEjemTangDisco.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.45\textwidth]{Gráficas/SolRevDiscEjeLnRecta.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.40\textwidth]{Gráficas/SolRevDiscEjeLnRecta2.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.34\textwidth]{Gráficas/SolRevDiscEjeLnRecta3.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \caption{El sólido}
    \includegraphics[width=0.38\textwidth]{Gráficas/SolRevDiscEjeLnRecta4.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \caption{Región a girar}
    \includegraphics[width=0.46\textwidth]{Gráficas/SolRevArandRegDefin.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.33\textwidth]{Gráficas/SolRevArandDefin.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \caption{El sólido}
    \includegraphics[width=0.34\textwidth]{Gráficas/SolRevArandDefin3d.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.36\textwidth]{Gráficas/SolRevArandela.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.44\textwidth]{Gráficas/SolRevArandEjeRecParab.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.33\textwidth]{Gráficas/SolRevArandEjeRecParabArandel.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.32\textwidth]{Gráficas/SolRevArandEjeRecParabSolido.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption{Región a girar}
    \label{fig:aran_dela}
    \includegraphics[width=0.30\textwidth]{Gráficas/SolRevArandEjeRecParabol2.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.30\textwidth]{Gráficas/SolRevArandEjeRecParab2Arandela.eps}
    \vspace{0.3em}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.30\textwidth]{Gráficas/SolRevArandEjeRecParab2Solido.eps}
    \vspace{0.3em}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.43\textwidth]{Gráficas/SolRevArandEjeLn.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.32\textwidth]{Gráficas/SolRevArandEjeLnArandel.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.25\textwidth]{Gráficas/SolRevArandEjeLnSolido.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.48\textwidth]{Gráficas/SolRevArandEjeRacion.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.33\textwidth]{Gráficas/SolRevArandEjeRacionArandel.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.35\textwidth]{Gráficas/SolRevArandEjeRacionSolido.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \caption{Región a girar}
    \includegraphics[width=0.28\textwidth]{Gráficas/SolRevArandParabRecta.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.28\textwidth]{Gráficas/SolRevArandParabRecta2.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.20\textwidth]{Gráficas/SolRevArandParabRecta3.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.30\textwidth]{Gráficas/SolRevArandEjeParabRect.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.28\textwidth]{Gráficas/SolRevArandEjeRecParabol.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.29\textwidth]{Gráficas/SolRevArandEjeRecParabol2.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.28\textwidth]{Gráficas/SolRevArandEjeRecParabol3.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \caption{El sólido}
    \includegraphics[width=0.28\textwidth]{Gráficas/SolRevArandEjeRecParabol4.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \caption{Región a girar}
    \includegraphics[width=0.25\textwidth]{Gráficas/SolRevArandExponen.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \caption{Los radios}
    \includegraphics[width=0.29\textwidth]{Gráficas/SolRevArandExponen2.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.24\textwidth]{Gráficas/SolRevArandExponen3.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.21\textwidth]{Gráficas/SolRevArandExponen4.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \caption{Región y sólido del ejemplo}
    \includegraphics[width=0.42\textwidth]{Gráficas/CasquillosGradCinco.eps}
    \vspace{0.3em}
    \propia
\end{figure}
\vskip0.2cm
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.41\textwidth]{Gráficas/CasquillosGradCincoCasquill.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.32\textwidth]{Gráficas/CasquillosGradCinco3D.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.34\textwidth]{Gráficas/CasquillAlredx3.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.34\textwidth]{Gráficas/CasquillAlredx3_2.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \caption{Casquillo}
    \includegraphics[width=0.34\textwidth]{Gráficas/CasquillAlredx3_3.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \caption{Sólido}
    \includegraphics[width=0.34\textwidth]{Gráficas/CasquillAlredx3Solid.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \caption{Región a girar}
    \includegraphics[width=0.32\textwidth]{Gráficas/CasquiAlredEjey.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.30\textwidth]{Gráficas/CasquillAlredyx4Solid.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \caption{Casquillo}
    \includegraphics[width=0.29\textwidth]{Gráficas/CasquillAlredyx4_1.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.29\textwidth]{Gráficas/CasquiAlredEjey4.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption{El sólido}
    \label{fig:solido_casquillo_}
    \includegraphics[width=0.27\textwidth]{Gráficas/CasquiAlredEjey4Solid.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.28\textwidth]{Gráficas/CasquiAlredEjey4Casqui.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.35\textwidth]{Gráficas/CasquiAlredEjey2.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.30\textwidth]{Gráficas/CasquiAlredEjey2Solid.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.40\textwidth]{Gráficas/CasquiAlredEjey2Casqui.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.36\textwidth]{Gráficas/LongCurvaDef.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \caption{Longitud}
    \includegraphics[width=0.44\textwidth]{Gráficas/LongCurvaRecta.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.35\textwidth]{Gráficas/LongCurvalnSen.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \caption{Longitud por medir}
    \includegraphics[width=0.48\textwidth]{Gráficas/LongCurvax2ln.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \caption{Longitud por medir}
    \includegraphics[width=0.32\textwidth]{Gráficas/LongCurvEx.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \caption{Longitud por medir}
    \includegraphics[width=0.40\textwidth]{Gráficas/LongCurva21ln.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.38\textwidth]{Gráficas/SupRevolDef.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.35\textwidth]{Gráficas/SupRevolDef2.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.30\textwidth]{Gráficas/SupRevolDefBand.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.28\textwidth]{Gráficas/SupRevolDefCompl.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.41\textwidth]{Gráficas/SuperRevolAlrxCurva.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption{Superficie}
    \vspace{-2mm}
    \includegraphics[width=0.35\textwidth]{Gráficas/SuperRevolAlrxSuperf.eps}
    \vspace{0.3em}
    \propia
\end{figure}
\vskip0.2cm
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.30\textwidth]{Gráficas/SuperRevol2Raiz.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.32\textwidth]{Gráficas/SuperRevol2RaizCompl.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \caption{Curva a girar}
    \includegraphics[width=0.35\textwidth]{Gráficas/SupRevolX3.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.55\textwidth]{Gráficas/SupRevolX3Solido.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \caption{Curva a girar}
    \includegraphics[width=0.30\textwidth]{Gráficas/SupRevolAlredY3.eps}
    \vspace{0.3em}
    \propia
\end{figure}
\vskip0.2cm
...
\begin{figure}[htbp]
    \centering
    \caption{La superficie}
    \includegraphics[width=0.40\textwidth]{Gráficas/SupRevolAlredY3Superf.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \caption{Curva a girar}
    \includegraphics[width=0.38\textwidth]{Gráficas/SupRevol2lny.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.38\textwidth]{Gráficas/SupRevol2lnySuperf.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{defi}\sl
\textnormal{Sea \textit{$F$} continua sobre el intervalo \textit{$[a,b]$} y sea \textit{$F(x)$} la fuerza en un número \textit{$x$} en el intervalo. \ Entonces, el trabajo \textit{$W$} realizado por la fuerza para mover un objeto de \textit{$a$} a \textit{$b$} es}
...
\begin{ejemplo}\sl
\textnormal{Cuando una part\'{\i}cula se localiza a una distancia de \textit{$x$} metros desde el origen, una fuerza de \textit{$F\left( x\right) =\cos \left( \frac{\pi x}{3}\right) $} newtons actúa sobre ella. \textquestiondown Cuánto trabajo se realiza al mover la part\'{\i}cula desde \textit{$x=0$} hasta \textit{$x=2?$}}
\end{ejemplo}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.45\textwidth]{Gráficas/FueraFuncTroz.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.45\textwidth]{Gráficas/Resorte.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.45\textwidth]{Gráficas/BombeoDef.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.45\textwidth]{Gráficas/TrabajTanqueHemisf.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.45\textwidth]{Gráficas/TrabajTanqueHemisf2.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\textit{Solución.} Dibujamos el tanque:

\noindent
\begin{figure}[htbp]
    \centering
    \caption{Tanque parabólico}
    \includegraphics[width=0.38\textwidth]{Gráficas/TrabajTanqueParabolic.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.38\textwidth]{Gráficas/PresPlacaHoriz.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.30\textwidth]{Gráficas/PresPlacaVertic.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.30\textwidth]{Gráficas/LaminaHorizontal5_6.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.30\textwidth]{Gráficas/FuerzaFluid1.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.30\textwidth]{Gráficas/FuerzaFluid2.eps}
    \vspace{0.3em}
    \propia
\end{figure}
\vspace{0.2cm}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.38\textwidth]{Gráficas/PlacaTriangularSumerg.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.38\textwidth]{Gráficas/PlacaParabolSumerg.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.40\textwidth]{Gráficas/MasaBarra.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.40\textwidth]{Gráficas/MasaLamina.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.48\textwidth]{Gráficas/MasaLaminaPartic.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.38\textwidth]{Gráficas/MasaLamParab.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.40\textwidth]{Gráficas/CentMasaUnid.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.35\textwidth]{Gráficas/TriangSustTang.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \caption{Lámina delgada}
    \includegraphics[width=0.38\textwidth]{Gráficas/MasaLamina.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.38\textwidth]{Gráficas/CentrMasaLamin2Parab.eps}
    \vspace{0.3em}
    \propia
\end{figure}
...
y=x^{2},y=x$}, con función de densidad \textit{$\rho \left( x\right) =12x.$}}
\end{ejemplo}
...
\begin{ejemplo}\sl
\textnormal{Halle el centro de masa de la placa delgada limitada por \textit{$%
y=x^{2},y=x$}, con función de densidad \textit{$\rho \left( x\right) =x^{2}.$}}
\end{ejemplo}
...
\begin{ejer}{En los ejercicios \eqref{masainic} al \eqref{masafin}, halle la masa y el centro de masa de las siguientes láminas delgadas\ representadas por la región limitada por las curvas o rectas dadas, con la función de densidad \textit{$\rho \left(x\right) $} indicada.}
\end{ejer}
