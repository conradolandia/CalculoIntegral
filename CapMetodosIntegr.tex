...
\begin{align*}
\int_{a}^{b}f(g(x))g^{\prime}(x)\,dx&=
\int_{g(a)}^{g(b)}f(u)du \text{, cambiando los limites de integraci\'{o}n}\\
...
\subsection*{Integrales de funciones trigonom\'{e}tricas}
...
\subsection*{Sustituci\'{o}n y f\'{o}rmulas de recurrencia}

Las funciones tangente y cotangente tienen unas propiedades particulares que nos permiten aplicar el método de sustituci\'{o}n para obtener ciertas f\'{o}rmulas de recurrencia. Tomemos inicialmente
\[
...
Es decir, se tiene la f\'{o}rmula de recurrencia:
\begin{equation*}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{Cuarto de círculo}
	\begin{minipage}{0.40\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Gráficas/CuartoCircul}
	\end{minipage}
...
%\end{center}
\vspace{0.2cm}
El \'{a}rea de la regi\'{o}n encerrada por la elipse $\frac{x^{2}}{a^{2}}+%
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{Área de elipse}
	\begin{minipage}{0.52\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Gráficas/elipse}
	\end{minipage}
...
\begin{ejemplo}\sl
\textnormal{Usemos ahora la inversa de una funci\'{o}n trigonométrica:}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{Región para inversa de secante}
	\begin{minipage}{0.45\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Gráficas/GrafArcsec.eps}
	\end{minipage}
...
\subsection*{Integraci\'{o}n de funciones pares e impares en un intervalo
sim\'{e}trico}
...
\item Si $f$ es una funci\'{o}n par y continua en el intervalo $\left[ -a,a\right],$ entonces \linebreak$\displaystyle{\int_{-a}^{a}f\left( x\right)dx=2\int_{0}^{a}f\left( x\right)dx.}$
\vskip0.7cm	
\item Si $f$ es una funci\'{o}n impar y continua en el intervalo $\left[ -a,a\right],$ entonces
...
&=\int_{-1}^{1}\underset{\text{funci\'{o}n impar}}{\underbrace{\left(
4x-2x^{3}-50x^{5}\right) }}dx+\int_{-1}^{1}\underset{\text{funci\'{o}n par}}{%
...
\begin{ejemplo}\sl
\textnormal{Suponga que \textit{$f$} es una funci\'{o}n par y que {\small \textit{$\displaystyle{\int_{0}^{32}f\left( x\right)
dx=20.}$}} Eval\'{u}e}
\[
...
\textit{Solución}. Si en {\footnotesize $\displaystyle{\int_{-2}^{2}x^{4}f\left( x^{5}\right) dx}$} hacemos la sustitución $\ u=x^{5}\rightarrow du=5x^{4}dx\rightarrow x^{4}dx=\frac{1}{5}du$ y cambiamos límites de integraci\'{o}n. Si $x=-2$, entonces {\footnotesize $u=\left( -2\right)^{5}=-32$} y, si $x=2$, entonces {\footnotesize $u=2^{5}=32$.}
\[
...
Esta f\'{o}rmula identifica el m\'{e}todo de integración por partes. Veamos su uso con algunos casos particulares:

\subsection*{Integrales de la forma \ $\displaystyle\int P(x)f(x)dx$}\label{ProdFunciones}

Tomemos el caso en donde $P\left( x\right) $ es un polinomio y $f(x)$ es una funci\'{o}n de tipo seno, coseno o exponencial, o $P(x)$ es una funci\'{o}n lineal y $f(x)$ es $\sec ^{2}x,\ \csc^{2}x,\ \tan ^{2}x,\ \cot ^{2}x.$
\vskip0.2cm
\begin{ejemplo}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{Tabla Partes}
	\begin{minipage}{0.70\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Gráficas/TablaPartes.eps}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{Tabla para integrar}
	\begin{minipage}{0.69\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Gráficas/TablaPartesERaiz}
	\end{minipage}
...
Algunas integrales pueden simplificarse usando las funciones inversas de las funciones que se pide integrar o de alguna de las funciones dentro del integrando. Eso se logra con una sustitución, y quizás así se obtenga una integral que se pueda hacer por el m\'{e}todo de partes o integraci\'{o}n tabular. Por ejemplo, en la función $f(x)=e^{\sqrt[3]{x}}$, se tiene la función $g(x)=\sqrt[3]{x}$ con inversa $g^{-1}(x)=x^3$, es decir, una expresión polinómica que puede ser más manejable que el radical de la función original; entonces, en la integral $\displaystyle{\int e^{\sqrt[3]{x}}dx}$, la sustitución $y=\sqrt[3]{x}\rightarrow y^3=x$ la convierte en
\[
...
\hline % Crea la línea superior
 &  & & $e^{y}$ & función \\
\hline % Crea la línea superior
\text{funci\'{o}n } & $y^{3}$ & $\underrightarrow{+}$ & $e^{y}$ & $\leftarrow \text{integral}$ \\
...
\hline
\hline
\text{funci\'{o}n } & $y$ & $\underrightarrow{+}$ & $\sen y$ & $\leftarrow \text{integral}$ \\
\hline
...
\begin{center}
	\begin{tabular}{|c|c|c|c|c|}
		...
		\hline
		\hline
		\text{funci\'{o}n } & $y^{2}$ & $\underrightarrow{+}$ & $\sen y$ & $\leftarrow \text{integral}$ \\
		\hline
...
\subsection*{La integral como una inc\'{o}gnita en una ecuaci\'{o}n}
...
El m\'{e}todo de integración por partes, con frecuencia, se usa para obtener algunas f\'{o}rmulas de recurrencia, es decir, expresiones que dependen de un paso anterior para poder encontrarlas.
\begin{ejemplo}\sl
...
\]
puede tomarse la sustituci\'{o}n trigonom\'{e}trica \ $\beta(x\pm \alpha)=a\sen
(\theta )$ con $\frac{-\pi }{2}\leq \theta \leq \frac{\pi }{2}$ (recordemos que el intervalo se toma, ya que la
funci\'{o}n seno tiene inversa allí). Luego, $\beta dx=a\cos (\theta )d\theta$; entonces, $dx=\cfrac{a\cos (\theta )}{\beta}%
d\theta $, y, por tanto, \
\vspace{-2mm}
\begin{eqnarray*}
...
\end{eqnarray*}
cuya integral final es m\'{a}s sencilla de encontrar.
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{Triángulo rectángulo de la sustitución}
	\begin{minipage}{0.37\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Gráficas/TriangSustSeno5_3.eps}
	\end{minipage}
	\hspace{1em}
...
\begin{ejemplo}\sl
\textnormal{Eval\'{u}e la integral} $\displaystyle{\int \frac{1-x}{-20-4x^{2}+24x}dx}$.
\end{ejemplo}
...
As\'{\i}; entonces, tomando la sustituci\'{o}n $x-3=2\sen(\theta ),$ con $\frac{-\pi }{2}< \theta < \frac{\pi }{2}$ y $dx=2\cos (\theta
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{Triángulo en la sustitución}
	\begin{minipage}{0.34\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Gráficas/TriangSustSeno.eps}
	\end{minipage}
	\hspace{1em} 
...
\begin{minipage}{\textwidth}
	...
	\begin{minipage}{0.28\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Gráficas/TriangSustSeno2.eps}
	\end{minipage}
	\hspace{1em}
...
\]
puede tomarse la sustituci\'{o}n trigonom\'{e}trica \ $\beta (x\pm a)=a\tan
(\theta )$ con $\frac{-\pi }{2}<\theta <\frac{\pi }{2}$ (recordemos que la
funci\'{o}n tangente tiene inversa en ese intervalo). Luego, $\beta dx=a\sec ^{2}(\theta)d\theta,$; entonces, $dx=\cfrac{a\sec ^{2}(\theta )}{\beta}d\theta $, y, por tanto,
\begin{eqnarray*}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{Triángulo con los datos de la sustitución}
	\begin{minipage}{0.28\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Gráficas/SustTrigonTang.eps}
	\end{minipage}
...
puede tomarse la sustituci\'{o}n trigonom\'{e}trica\ $\beta (x\pm a)=a\sec(\theta )$ con $0\leq \theta <\frac{\pi }{2}$ o $\pi \leq \theta <\frac{3\pi}{2}$ (la funci\'{o}n secante tiene inversa en este intervalo). Luego, $\beta dx=a\sec \theta \tan \theta d\theta$ y, con ello, $dx=\cfrac{a\sec \theta\tan \theta }{\beta }d\theta $. Por tanto,
{\small
\begin{eqnarray*}
...
cuya integral última es m\'{a}s sencilla, como antes.
...
\begin{minipage}{\textwidth}
	...
	\begin{minipage}{0.35\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Gráficas/SustTrigonSec}
	\end{minipage}
	\hspace{1em} 
...
\begin{minipage}{\textwidth}
	...
	\begin{minipage}{0.35\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Gráficas/SustTrigonSec2.eps}
	\end{minipage}
	\hspace{1em}
...
\textnormal{Calcule cada una de las siguientes integrales. Use una sustituci\'{o}n adecuada.}\\
